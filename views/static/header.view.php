<header class="text-gray-400 bg-indigo-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a class="flex title-font font-medium items-center text-white mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl">CRUD</span>
        </a>
        ...
        <div class="dropdown inline-block relative">
            <button class="flex items-center text-indigo-500 font-bold bg-white border-0 py-2 px-3 focus:outline-none hover:bg-gray-100 rounded text-base mt-4 md:mt-0">
                ...
                <span class="mr-1 flex items-center">User name </span>
            </button>

            <ul class="dropdown-menu w-auto absolute hidden font-bold text-gray-700 pt-2 text-center sm:right-0">

                <li class=""><a class="rounded-t sm:text-base text-sm bg-white hover:bg-gray-400 py-2 px-5 block " href="#"> 
                    online
                    oscargonz150@gmail.com
                </a></li>
                <!-- <li class=""><a class="bg-gray-200 hover:bg-gray-400 py-2 px-16 block " href="#">Two</a></li> -->
                <li class=""><a class="rounded-b bg-gray-300 hover:bg-red-500 hover:text-white py-2 block items-center text-center" href="#">
